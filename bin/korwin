...
# Define all parts of Korwin's sentence
korwin1=(
...
# Output all the parts of Korwin's sentence (add a space to separate them)
echo -n "${korwin1[$(shuf -i 1-6 -n 1)]} "
echo -n "${korwin2[$(shuf -i 1-6 -n 1)]} "
echo -n "${korwin3[$(shuf -i 1-6 -n 1)]} "
echo -n "${korwin4[$(shuf -i 1-6 -n 1)]} "
echo -n "${korwin5[$(shuf -i 1-6 -n 1)]} "
echo     ${korwin6[$(shuf -i 1-6 -n 1)]}
